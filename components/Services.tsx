const services = [
  {
    ...
    title: "Hitni Prevoz",
    description:
      "Nalazimo se u centru Beograda — stižemo za svega ~15 minuta. Brz odgovor i sanitetski transport pacijenata u hitnim situacijama, non-stop.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Od Kreveta do Kreveta",
    description:
      "Kompletna usluga od kreveta do kreveta — preuzimamo pacijenta direktno iz kreveta i dovodimo na odredište. Prevoz nepokretnih i slabo pokretnih lica.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Prevoz Pacijenata do Bolnice",
    description:
      "Privatni sanitetski prevoz do bolnica, klinika i zdravstvenih ustanova u Beogradu i celoj Srbiji. Medicinski transport sa opremljenim vozilima.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Prevoz Nepokretnih Lica",
    description:
      "Specijalizovano vozilo i obučeno osoblje za bezbedni prevoz nepokretnih i teško pokretnih pacijenata — na dijalizu, hemioterapiju, preglede i rehabilitaciju.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Sanitetski prevoz u inostranstvo i međunarodni medicinski transport pacijenata. Organizujemo prevoz u sve evropske zemlje — bezbedno i profesionalno.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Čekanje Pacijenta & 0-24h",
    description:
      "Opcija čekanja pacijenta tokom pregleda ili zahvata i povratni prevoz. Sanitetski prevoz dostupan 0-24h, sva dana u nedelji, vikendima i praznicima.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Kompletan sanitetski prevoz i medicinski transport pacijenata u Beogradu, Srbiji i inostranstvu.
            Privatni sanitetski prevoz 0-24h — bezbednost i komfor su naš prioritet.
          </p>
        </div>
